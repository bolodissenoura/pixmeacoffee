              ...
              {props.data.socialLinks[0]?.value?.length > 10 ? (
                <>
                  <Link
                    ...
                    {svgIconsSocialMedia(props.data.socialLinks[0].name)}
                  </Link>
                </>
              ) : (
                <></>
              )}
              {props.data.socialLinks[1]?.value?.length > 10 ? (
                <>
                  <Link
                    key={props.data.socialLinks[1].name}
                    href={props.data.socialLinks[1].value}>
                    {svgIconsSocialMedia(props.data.socialLinks[1].name)}
                  </Link>
                </>
              ) : (
                <></>
              )}
              {props.data.socialLinks[2]?.value?.length > 10 ? (
                <>
                  <Link
                    key={props.data.socialLinks[2].name}
                    href={props.data.socialLinks[2].value}>
                    {svgIconsSocialMedia(props.data.socialLinks[2].name)}
                  </Link>
                </>
              ) : (
                <></>
              )}
              {props.data.socialLinks[3]?.value?.length > 10 ? (
                <>
                  <Link
                    key={props.data.socialLinks[3].name}
                    href={props.data.socialLinks[3].value}>
                    {svgIconsSocialMedia(props.data.socialLinks[3].name)}
                  </Link>
                </>
              ) : (
                <></>
